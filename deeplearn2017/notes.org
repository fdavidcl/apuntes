...
en lugar de softmax, función de binarización en la capa de salida
** Autoencoder composition

or online adding a smaller encoding layer and progressively fine-tuning
